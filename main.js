 ...
 * @since 2024-01-01
 */
import { createAppInitializer } from './js/modules/appInitializer.js';
import { createAppStateManager } from './js/modules/appStateManager.js';
import { createDataSyncService } from './js/modules/dataSyncService.js';
import { createUIRenderer } from './js/modules/uiRenderer.js';
import { createShareManager } from './js/modules/shareManager.js';
import { getAppContext, initializeAppContext } from './js/modules/appContext.js';
import { createGlobalBridge } from './js/modules/globalBridge.js';
import { createInitializationChain } from './js/modules/initializationChain.js';
import { $, $$, cleanupSidebar, checkVersion, getDefaultData } from './js/modules/utils.js';
// ========================================
// 앱 초기화
// ========================================
/**
...
async function initialize_app() {
    ...
    try {
        ...
        let loadDataFromFirestore;
        let globalBridgeRef = null;
        loadDataFromFirestore = async () => {
            ...
            if (context.dataSyncService && context.dataManager && !context.dataSyncService.dataManager) {
                console.log('DataManager를 DataSyncService에 설정 중...');
                context.dataSyncService.setDataManager(context.dataManager);
            }
            if (context.dataSyncService && context.authManager && !context.dataSyncService.authManager) {
        ...
        if (context.leagueManager) {
            window.leagueManager = context.leagueManager;
            console.log('window.leagueManager 등록 확인:', typeof window.leagueManager?.createClass);
        }
        else {

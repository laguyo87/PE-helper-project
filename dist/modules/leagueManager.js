...
export class LeagueManager {
    ...
    renderLeagueUI() {
        ...
        `;
            ...
            if (sidebar) {
                ...
                const importInput = this.getElement('#importAllLeaguesExcel');
                if (importInput) {
     ...
     */
    handleAllLeaguesExcelUpload(event) {

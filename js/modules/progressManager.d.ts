...
export declare class ProgressManager {
    ...
    constructor($: (selector: string) => HTMLElement | null, $$: (selector: string) => NodeListOf<HTMLElement>, saveCallback: () => void);
    /**
     * 초기화
     */
 ...
 */
export declare function initializeProgressManager($: (selector: string) => HTMLElement | null, $$: (selector: string) => NodeListOf<HTMLElement>, saveCallback: () => void): ProgressManager;
